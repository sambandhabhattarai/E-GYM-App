...
{
    public class ChestExercisesViewModel : INotifyPropertyChanged
    {
        ...
        public ChestExercisesViewModel()
        {
            ...
            {
                new Exercise { ExerciseName = "Push-Up", ImageSource = "push_up.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Bench Press", ImageSource = "bench_press.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Chest Fly", ImageSource = "chest_fly.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Dip", ImageSource = "dip.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Shoulder Tap", ImageSource = "shoulder_taps.gif", Sets = "3-4", Time = "45-60 seconds per set" }
            };
