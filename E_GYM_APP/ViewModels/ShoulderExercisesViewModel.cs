...
{
    public class ShoulderExercisesViewModel : INotifyPropertyChanged
    {
        ...
        public ShoulderExercisesViewModel()
        {
            ...
            {
                new Exercise { ExerciseName = "Front Raise", ImageSource = "dumbell_front_raise.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Lateral Raise", ImageSource = "dumbell_lateral_raise.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Military Press", ImageSource = "seated_military_press.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Reverse Fly", ImageSource = "reverse_fly.gif", Sets = "3-4", Time = "45-60 seconds per set" }
            };
