...
{
    public class BicepsExercisesViewModel : INotifyPropertyChanged
    {
        ...
        public BicepsExercisesViewModel()
        {
            _WorkoutDatabase = new WorkoutDatabase();
            Exercises = new ObservableCollection<Exercise>
            {
                new Exercise { ExerciseName = "Double Arm Dumbell Curl", ImageSource = "double_arm_dumbbell_curl.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Waiter Curl", ImageSource = "waiter_curl.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Seated Zottman Curl", ImageSource = "seated_zottman_curl.gif", Sets = "3-4", Time = "45-60 seconds per set" },
                new Exercise { ExerciseName = "Rop Biceps Curl", ImageSource = "rope_bicep_curls.gif", Sets = "3-4", Time = "45-60 seconds per set" },
            };
